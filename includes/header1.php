	...
	<div id = "shell">
		<div id = "header">
			...
			<div class = "cl">
				...
				<div id="js-slider">
					<div><img src="images/01.jpg" alt="salon"></div>
				<!--<div><img src="images/photo02.jpg" alt="salon"></div> -->
				<div><img src = "images/03.jpg" alt="restaurant"></div>
				<!--<div><img src = "images/photo04.jpg" alt="vaccuum"></div> -->
				</div> <!--js-slider-->
					<div id="phone">
					</div> <!--phone-->
					<div class = "cl20">
					...
					<div id="content">
						...
						<section id="right">
							...
							<fieldset>
								<p><label><span>email:</span> <input type="text" name="email" size="10" maxlength="30" /></label></p>
								<p><label><span>zip code:<span></span> <input type="text" name="zipcode" size="5" maxlength="5" /></label></p>
							</fieldset>
